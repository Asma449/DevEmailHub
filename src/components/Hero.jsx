...
const Hero = () => {
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-6rem)]">
      <div
  data-aos="fade-right"
  data-aos-offset="300"
...
>
        ...
        <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem] mt-4">
          THE BEST WAY TO REACH HUMANS INSTEAD OF SPAM FOLDERS, DEVELOP
        ...
        <div className="flex gap-4 mt-12">
         ...
         <Spline className="absolute lg:top-0 top-[-20%] bottom=0  lg:left-[25%] sm:left-[-2%] h-full" scene="https://prod.spline.design/K879xwx5v2pAR74D/scene.splinecode" />
